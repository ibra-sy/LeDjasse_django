"""
Django settings for django_SYLLA project.
...
SECRET_KEY = 'django-insecure-0ojc)+%dlzl#(hdxvet-w54a6@t1ng&_bj@uc3c87j_qj3c8-g'
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Token': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': 'Format : Token 08f1350f28684d1012cac5dc2911d9942f397981'
        }
    },
...
ROOT_URLCONF = 'django_SYLLA.urls'
...
EMAIL_HOST_PASSWORD = 'mgsp czps dgbj qjmr'
